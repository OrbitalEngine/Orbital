...
public class ResourceManager {
  ...
  /**
   * Gets a sprite if stored in the resource manager, otherwise adds it to the resource manager and
   * returns it.
   *
  ...
  public static <T> Sprite getSprite(Class<T> klass, String path) {
    ...
    if (file.exists()) {
      ...
      throw new IllegalStateException(
          "Sprite does not exist at location '" + file.getAbsolutePath() + "'");
    }
  }
  ...
  /**
   * Gets a font if stored in the resource manager, otherwise adds it to the resource manager and
   * returns it.
   *
  ...
  public static <T> Font getFont(Class<T> klass, String path) {
    ...
    if (file.exists()) {
      ...
      throw new IllegalStateException(
          "Font does not exist at location '" + file.getAbsolutePath() + "'");
    }
  }
  ...
  /**
   * Gets an audio clip if stored in the resource manager, otherwise adds it to the resource manager
   * and returns it.
   *
  ...
  public static <T> AudioClip getAudioClip(Class<T> klass, String path) {
    ...
    if (file.exists()) {
      ...
      throw new IllegalStateException(
          "Audio clip does not exist at location '" + file.getAbsolutePath() + "'");
    }
  }
  ...
  public static void disposeAudioClip(AudioClip clip) {
    ...
    if (AUDIO_CLIPS.containsKey(file.getAbsolutePath())) {
      ...
      throw new IllegalStateException(
          "Audio clip is not loaded in resource manager, cannot dispose.");
    }
  }
  ...
  /**
   * Gets a music resource if stored in the resource manager, otherwise adds it to the resource
  ...
  public static <T> Music getMusicStream(Class<T> klass, String path) {
    ...
    if (file.exists()) {
      ...
      throw new IllegalStateException(
          "Music file does not exist at location '" + file.getAbsolutePath() + "'");
    }
  }
