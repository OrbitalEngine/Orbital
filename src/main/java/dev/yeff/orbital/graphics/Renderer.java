...
public class Renderer {
  ...
  public static void drawRect(Color color, Vector2f pos, Vector2f size) {
    DrawRectangleV(
        RaylibUtil.getAsRaylibVec2(pos),
        RaylibUtil.getAsRaylibVec2(size),
        RaylibUtil.getRaylibColor(color));
  }
  ...
  public static void drawRect(Color color, Vector2f pos, float size) {
    DrawRectangleV(
        RaylibUtil.getAsRaylibVec2(pos),
        new Raylib.Vector2().x(size).y(size),
        RaylibUtil.getRaylibColor(color));
  }
  ...
  public static void drawRectOutline(Vector2f pos, Vector2f size, Color color) {
    DrawRectangleLines(
        (int) pos.x, (int) pos.y, (int) size.x, (int) size.y, RaylibUtil.getRaylibColor(color));
  }
  ...
  public static void drawRectOutline(Vector2f pos, float size, Color color) {
    DrawRectangleLines(
        (int) pos.x, (int) pos.y, (int) size, (int) size, RaylibUtil.getRaylibColor(color));
  }
  ...
  public static void drawLine(Vector2f start, Vector2f end, Color color) {
    DrawLine(
        (int) start.x, (int) start.y, (int) end.x, (int) end.y, RaylibUtil.getRaylibColor(color));
  }
  ...
  public static void drawLine(Vector2f start, Vector2f end, Color color, float thickness) {
    DrawLineEx(
        RaylibUtil.getAsRaylibVec2(start),
        RaylibUtil.getAsRaylibVec2(end),
        thickness,
        RaylibUtil.getRaylibColor(color));
  }
  ...
  public static void drawString(String text, float fontSize, Vector2f pos) {
    DrawText(
        ...
        (int) pos.y,
        (int) fontSize,
        RaylibUtil.getRaylibColor(new Color(0, 0, 0)));
  }
  ...
  public static void fillBackground(Color color) {
    ClearBackground(RaylibUtil.getRaylibColor(color));
  }
}
